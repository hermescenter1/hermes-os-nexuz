/**
 * Minimal ambient declarations for the subset of the Figma Plugin API this
...
type Effect = DropShadowEffect | BackgroundBlurEffect | { type: string; [k: string]: unknown }
