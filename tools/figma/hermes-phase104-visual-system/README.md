...
- `npm run test` — 58 policy, mutation and runtime-contract tests asserting the
  ...
  never becomes a glow, motion stays in the 120–240 ms band, and dynamic pages are
  loaded and awaited before any recursive managed-asset scan.
