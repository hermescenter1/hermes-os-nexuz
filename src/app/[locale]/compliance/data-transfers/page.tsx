...
export const metadata = { title: "Data Transfers · Compliance · Hermes OS" };
    ...
    <PageShell ambient={2}>
      <div className="mx-auto max-w-screen-2xl px-6 sm:px-8 pb-20">
        <div className="page-header-premium">
          ...
          <h1 className="type-page-title">{t("nav.dataTransfers")}</h1>
        </div>
        <ComplianceCenterClient view="data-transfers" />
      </div>
    </PageShell>
  );
}
