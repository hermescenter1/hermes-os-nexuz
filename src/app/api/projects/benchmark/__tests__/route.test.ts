 ...
 *
 * Phase 82D.1: /api/projects/benchmark is authoring-gated (hard 401/403).
...
describe("GET /api/projects/benchmark — auth gate", () => {
  ...
  it("lets an authoring user reach the benchmark service (200)", async () => {
    const { GET } = await import("../route");
    const res = await GET();
