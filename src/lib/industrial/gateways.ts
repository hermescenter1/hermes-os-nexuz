...
export async function listGateways(
  ...
  // PHASE 99 SECURITY — see listAssets: this `if/else` let an explicit siteId
  // REPLACE the Phase 43 allow-list rather than narrow it, so a caller granted
  // one site could enumerate another site's gateways — including apiKeyId and
  // metadata — simply by naming that site in the query string.
