...
describe("catalog + navigation + boundary invariants", () => {
  it("orgAdministration: en/fa/de parity, de is genuinely German, no Arabic yeh/kaf, ICU parity", () => {
    ...
    // PHASE 87L.6C SUPERSEDES the "de = en verbatim" pin: orgAdministration is
    // genuinely German now. Key shape stays identical (asserted above).
    expect(JSON.stringify((de as unknown as typeof en).orgAdministration)).not.toBe(JSON.stringify(en.orgAdministration));
