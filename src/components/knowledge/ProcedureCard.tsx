  ...
  return (
    <GlassCard className="p-4 space-y-2">
      <div className="flex items-start justify-between gap-2">
        <p className="font-semibold text-white text-sm leading-tight" dir="auto">{p.title}</p>
      ...
      {p.description && (
        <p className="text-white/40 text-xs leading-relaxed" dir="auto">{p.description}</p>
      )}
      ...
      <div className="flex items-center gap-3 pt-1 text-xs text-white/25 font-mono">
