  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
        ...
        <div className="rounded-xl border bg-card p-4">
          <div className="text-xs text-muted-foreground mb-1">Triggered By</div>
          <div className="font-medium">{execution.triggeredBy ?? "system"}</div>
        </div>
        <div className="rounded-xl border bg-card p-4">
      ...
      {execution.steps.length > 0 && (
        <div className="space-y-3">
          <h3 className="font-semibold">Execution Steps ({execution.steps.length})</h3>
      ...
      {execution.logs.length > 0 && (
        <div className="space-y-2">
          <h3 className="font-semibold">Logs ({execution.logs.length})</h3>
