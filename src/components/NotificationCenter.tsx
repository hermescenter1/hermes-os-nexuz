...
const TYPE_CONFIG: Record<NotificationType, { dot: string; label: string }> = {
  ...
  security: { dot: "bg-purple-400",  label: "Security" },
};
      ...
      >
        ...
        {unreadCount > 0 && (
          <span
            ...
            className="absolute -right-0.5 -top-0.5 flex h-4 min-w-[1rem] items-center justify-center rounded-full bg-signal px-0.5 text-[0.55rem] font-bold leading-none text-bg"
          >
