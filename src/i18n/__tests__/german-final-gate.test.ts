...
describe("87L.6F — full 5,136-leaf reconciliation (§2)", () => {
  ...
  it("satisfies 6222 = translations + identicals + tokens + numeric/unit", () => {
