...
// residual hard-coded English the whole-page F03 check could not see.
  ...
  it("satisfies 7282 = translations + identicals + tokens + numeric/unit", () => {
    ...
    // 109-C-UI.3: 7282 -> 7342, the same +60 otEdge.controlRoom leaves counted
    // in the catalogue assertion above. They reconcile as translations, not as
    // identicals or tokens: every German value differs from its English source.
    ).toBe(7362);
